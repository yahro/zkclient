...
public class ContentWatcherTest {
    ...
    public void setUp() throws Exception {
        LOG.info("------------ BEFORE -------------");
        _zkServer = TstUtil.startZkServer("ContentWatcherTest", 4711);
    ...
    public void testGetContent() throws Exception {
        ...
        String contentFromWatcher = TstUtil.waitUntil("b", new Callable<String>() {
    ...
    public void testHandlingOfConnectionLoss() throws Exception {
        ...
        TstUtil.waitUntil("b", new Callable<String>() {
