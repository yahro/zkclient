...
public class ServerZkClientTest extends AbstractBaseZkClientTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        _zkServer = TstUtil.startZkServer("ZkClientTest_" + _counter.addAndGet(1), 4711);
    ...
    public void testRetryUntilConnected_SessionExpiredException() {
        ...
        // ZkServer zkServer = TstUtil.startZkServer("ZkClientTest-testSessionExpiredException", 4711, 100);
        Gateway gateway = new Gateway(4712, 4711);
        gateway.start();
    ...
    public void testChildListenerAfterSessionExpiredException() throws Exception {
        ...
        Boolean hasOneChild = TstUtil.waitUntil(true, new Callable<Boolean>() {
